...
class Pluginaxis_network_camera_plugin(plugins.Base):
    def __init__(self):
        pass
    ...
    def start(self):
        self.rules = [
            ...
            { "text" : '<FRAME NAME="WhatEver" SRC="/incl/whatever.shtml" SCROLLING=NO MARGINHEIGHT=0 MARGINWIDTH=0>' },
            { "text" : '<FRAME NAME="Trash" SRC="/view/trash.shtml" SCROLLING=NO MARGINHEIGHT=0 MARGINWIDTH=0>' },
            { "text" : '<FRAME NAME="Temp" SRC="/view/temp.shtml" SCROLLING=NO MARGINHEIGHT=0 MARGINWIDTH=0>' },
