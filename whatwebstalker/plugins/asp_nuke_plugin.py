...
class Pluginasp_nuke_plugin(plugins.Base):
    ...
    def start(self):
        self.rules = [
            ...
            { "regexp" : r'<link rel="Shortcut Icon" href="[^>]*aspnuke.ico">' },
            { "regexp" : r'<a href="http://www.aspnuke.it" target="_blank">ASP-Nuke [0-9\.]*</a>' },
            { "text" : 'Designed with <a href="http://www.asp-nuke.net" target="_blank">ASP-Nuke</a>' },
            { "version" : "v1.1+", "text" : "<br>Designed with ASP-Nuke v1.1+" },
            { "version" : r'<meta name="Generator" (content|CONTENT)="(ASPNUKE|ASP-Nuke) ([^->"]+)', "offset" : "2", "name" : "meta generator tag" },
            { "version" : r'Designed with <a href="http://www.asp-nuke.net" target="_blank">ASP-Nuke</a> ([^<]+)<br>', "name" : "desgined by" },
            { "version" : r'<a href="http://www.aspnuke.it" target="_blank">Asp-Nuke ([\d\.]+)</a>', "name" : "aspnuke.it" },
