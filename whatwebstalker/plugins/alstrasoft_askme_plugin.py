...
class Pluginalstrasoft_askme_plugin(plugins.Base):
    ...
    def start(self):
        self.rules = [
			...
			{ "text" : "<br> Powered by <a href='http://www.alstrasoft.com' target='_blank'><font color=blue>AlstraSoft AskMe Pro</font></a><br><br>" },
			{ "text" : "<td colspan=2 align=\"center\"><a href=\"pass_recover.php\">Forgotten Password?</a></td>" },
			{ "text" : "Powered By <a href=\"http://www.alstrasoft.com\">AlstraSoft AskMe Pro</a></td></tr></table></body></html>" },
		]
        return self.rules