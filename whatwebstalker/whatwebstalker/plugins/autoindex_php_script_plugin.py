...
class Pluginautoindex_php_script_plugin(plugins.Base):
    ...
    def start(self):
        self.rules = [
            ...
            {"text": "<div class="small" style="text - align: right
             ">Powered by <a class="default_a" href="autoindex.sourceforge.net / ">AutoIndex PHP Script</a></div>"},
            {"text": "<div class="autoindex_small" style="text - align: right
             ">Powered by <a class="autoindex_a" href="autoindex.sourceforge.net / " target="_blank">AutoIndex PHP Script</a></div>"},
